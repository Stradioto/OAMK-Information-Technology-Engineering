   ...
   if ( desired_number_of_levels > 2 && desired_number_of_levels < 21 )
   {
                ...
                level_counter ++ )
      {
                   ...
                   double_character_counter ++ )
         {
            ...
            process.stdout.write( given_pyramid_character ) ;
            //process.stdout.write( "==" ) ; // print double character
         }
      }
   }
   else
...
function print_hollow_pyramid( desired_number_of_levels, given_pyramid_character = "\\" )
{
   if ( desired_number_of_levels > 2 && desired_number_of_levels < 21 )
   {
      for ( let level_counter = 1;
                ...
                level_counter ++ )
      {
         ...
         for ( let double_character_counter = 0 ;
                   ...
                   double_character_counter ++ )
         {
            if((level_counter == 1) && (double_character_counter == 0 ))
             {
               process.stdout.write( "/\\" ) ;
            ...
            process.stdout.write( given_pyramid_character ) ;
             ...
             else if((level_counter == desired_number_of_levels) && (double_character_counter == 0 ))
             {
               process.stdout.write( "//" ) ;
              //process.stdout.write( "||" ) ;
             }
             else if((level_counter == desired_number_of_levels ))
             {
               process.stdout.write( "--" ) ;
              //process.stdout.write( "||" ) ;
             }
           
             else if((double_character_counter == 0) && (level_counter != desired_number_of_levels))
             {
               process.stdout.write( "//" ) ;
              //process.stdout.write( "||" ) ;
             }
...
print_hollow_pyramid( 16 ) ;  // print a pyramid with 18 levels
